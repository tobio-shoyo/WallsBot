...
def main():
    ...
    dispatcher.add_handler(wall_handler, run_async=True)
    dispatcher.add_handler(wcolor_handler, run_async=True)
    dispatcher.add_handler(editors_handler, run_async=True)
    dispatcher.add_handler(random_handler, run_async=True)
    dispatcher.add_handler(colors_handler, run_async=True)
    dispatcher.add_handler(about_handler, run_async=True)
    dispatcher.add_handler(anime_handler, run_async=True)
    dispatcher.add_handler(restart_handler, run_async=True)
    dispatcher.add_handler(apistatus_handler, run_async=True)
    dispatcher.add_error_handler(error, run_async=True)
